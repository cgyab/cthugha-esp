...
**Total distinct combinations: ~314 million**

15 flames × 26 waves × 10 display modes × 8 translate states × 9 palettes ×
...
└── main/
    ...
    ├── waves.c                 # 26 wave renderers (ported from MODES.C + PETE.C)
